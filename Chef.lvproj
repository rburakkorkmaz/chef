	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support" Type="Folder">
			<Item Name="Controls" Type="Folder">
				<Item Name="Ocak.ctl" Type="VI" URL="../Support/Controls/Ocak.ctl"/>
				<Item Name="Timer Indicator.ctl" Type="VI" URL="../Support/Controls/Timer Indicator.ctl"/>
			</Item>
			<Item Name="Recipe" Type="Folder">
				<Item Name="Recipe.lvclass" Type="LVClass" URL="../Support/Recipe/Recipe.lvclass"/>
			</Item>
			<Item Name="Recipe Step" Type="Folder">
				<Item Name="private" Type="Folder"/>
				<Item Name="protected" Type="Folder"/>
				<Item Name="utils" Type="Folder"/>
				<Item Name="Recipe Step.lvclass" Type="LVClass" URL="../Support/Recipe Step/Recipe Step.lvclass"/>
			</Item>
		</Item>
		<Item Name="Unit Tests" Type="Folder">
			<Item Name="Recipe" Type="Folder">
				<Item Name="UT_AddNewStep.vi" Type="VI" URL="../Unit Tests/Recipe/UT_AddNewStep.vi"/>
			</Item>
		</Item>
